...
public class ShipmentTypeUtil {
	public void generatePie(String path,List<Object[]> data) {
		...
		try {
			System.out.println(new File(path+"/resources/images/shipmentPie.jpg"));
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		try { ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/shipmentBar.jpg"), chart, 400, 400); } catch (IOException e) {
			e.printStackTrace();
		}
	}
}
